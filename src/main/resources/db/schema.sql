...
--     id
-- ) ON DELETE SET NULL,
--     CONSTRAINT fk_feedbacks_questions FOREIGN KEY
-- (
--     question_id
-- ) REFERENCES question
-- (
...
--     user_id
-- ),
--     CONSTRAINT fk_likes_posts FOREIGN KEY
-- (
--     post_id
-- ) REFERENCES posts
-- (
--     id
-- ) ON DELETE SET NULL,
--     CONSTRAINT fk_likes_users FOREIGN KEY
-- (
--     user_id
-- ) REFERENCES users
-- (
...
-- VALUES ('user1@example.com', 'User One', 'https://api.dicebear.com/7.x/miniavs/svg?seed=3'),
...
-- VALUES ('프론트엔드 기술면접', 'React와 Vue.js의 차이점은 무엇인가요?', 1, 3),
...
-- -- AI 기술면접 질문 데이터
-- INSERT INTO question (job, question, priority, difficulty)
-- VALUES ('AI 기술면접', '머신러닝과 딥러닝의 차이점은 무엇인가요?', 1, 4),
...
-- -- 안드로이드 기술면접 질문 데이터
-- INSERT INTO question (job, question, priority, difficulty)
-- VALUES ('안드로이드 기술면접', '안드로이드와 iOS의 차이점은 무엇인가요?', 1, 2),
...
-- -- IOS 기술면접 질문 데이터
-- INSERT INTO question (job, question, priority, difficulty)
-- VALUES ('IOS 기술면접', 'Swift와 Objective-C의 차이점은 무엇인가요?', 1, 2),
...
-- -- 게임 기술면접 질문 데이터
-- INSERT INTO question (job, question, priority, difficulty)
-- VALUES ('게임 기술면접', '게임 엔진에서 렌더링 파이프라인은 어떻게 작동하나요?', 1, 5),
...
-- -- 마케터 면접 질문 데이터
-- INSERT INTO question (job, question, priority, difficulty)
-- VALUES ('마케터 면접', 'A/B 테스트란 무엇이며, 마케팅에 어떻게 활용하나요?', 1, 3),
...
-- -- 디자이너 면접 질문 데이터
-- INSERT INTO question (job, question, priority, difficulty)
-- VALUES ('디자이너 면접', 'UI와 UX의 차이점은 무엇인가요?', 1, 3),
...
--
-- INSERT INTO question (job, question, priority, difficulty)
-- VALUES ('PM 기술면접', '프로젝트 관리에서 애자일 방법론의 장점은 무엇인가요?', 1, 2),
...
-- -- 공통 인성면접 질문 데이터
-- INSERT INTO question (job, question, priority, difficulty)
-- VALUES ('공통 인성면접', '자신의 강점과 약점에 대해 이야기해보세요.', 1, 2),
